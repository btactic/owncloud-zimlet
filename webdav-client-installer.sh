...
OWNCLOUD_ZIMLET_CLONE_URL="git://github.com/btactic/owncloud-zimlet"
OWNCLOUD_ZIMLET_CLONE_BRANCH="btactic-2018-proxy-development"
...
owncloud_zimlet_app_title=bDrive
